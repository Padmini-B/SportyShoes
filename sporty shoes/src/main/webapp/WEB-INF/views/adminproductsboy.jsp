...
<body align="center">
	<jsp:include page="adminheader.jsp" />
	 <a href="adminproductsboy"
		style="text-decoration: none; font-size: 30px; color: Black">Men</a>&emsp;
	<a href="adminproductsgirl"
		style="text-decoration: none; font-size: 30px; color: Black">Women</a>
		<br><br>
	<c:forEach items="${products_boy}" var="pb" varStatus="status" step="1" begin="0">
		<div class="col${status.index % 3 + 1}">
			<c:if test="${pb.category=='men'}">
				<a href="view_product" style="color:Black"><img src="<c:url value="${pb.image}"/>" style="width: 50%; height: 50%; border: 1px solid"/>
				<br><b>Brand: ${pb.brand}<br>Category: ${pb.category}<br>Mrp: ${pb.mrp}</b><br><br></a>
				<form action="addtocart" method="post">
					...
					<button class="button" type="submit" class="button">Add to Cart</button>
				</form>
				<br><br>
			</c:if>
		</div>
