...
<body align="center">
	...
	<a href="adminproductsboy" style="text-decoration:none;font-size:30px;color:Black">Men</a>&emsp;
	<a href="adminproductsgirl" style="text-decoration:none;font-size:30px;color:Black">Women</a>
	<c:forEach items="${products_girl}" var="pg" varStatus="status" step="1" begin="0">
